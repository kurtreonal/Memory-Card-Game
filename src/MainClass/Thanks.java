...
public class Thanks extends javax.swing.JFrame {
    ...
    private void gameOver() {
        int reset = JOptionPane.showOptionDialog(this, "Are you sure you want to quit?", "Game Reset",
    ...
    private void initComponents() {
        ...
        jPanel1.add(start, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 150, 70));
        ...
        jPanel1.add(quit, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 100, 70));

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Matching game-end.png"))); // NOI18N
