...
public class Level3 extends javax.swing.JFrame {
    ...
    public Level3() {
        ...
        cardButtons = new JLabel[]{
            ...
            cardButtons13, cardButtons14, cardButtons15,
            cardButtons16, cardButtons17, cardButtons18
        };

        cardImages = new ImageIcon[]{
            new ImageIcon(getClass().getResource(imagePath + "King.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "King.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "Queen.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "Queen.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "Jack.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "Jack.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S01.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S01.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S02.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S02.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S04.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S04.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S06.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S06.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S08.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S08.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S09.jpg")),
            new ImageIcon(getClass().getResource(imagePath + "S09.jpg")),
    ...
    private void initializeGame() {
        ...
        for (int i = 0; i < cardButtons.length; i++) {
            ...
            cardButtons[i].setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0))); // can be removed only for label border
            ...
            if (cardValues[getIndex(firstClicked)].equals(cardValues[getIndex(secondClicked)])) { //if the 1st card and 2nd card matched
                ...
                new java.util.Timer().schedule(new java.util.TimerTask() {
                    ...
                    public void run() {
                        ...
                        if (flipCount == 26) { //if flip counts reach 10 then its game over
                            JOptionPane.showMessageDialog(Level3.this, "Number of Flips Reached"); //message dialog
    ...
    private void win() {
        initializeGame();
        int reset = JOptionPane.showOptionDialog(this, "No more levels. Proceed to end credits", "Congrats!",
                JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null,
                new Object[]{"Yes", "No"}, JOptionPane.OK_OPTION);
    ...
    private void initComponents() {
        ...
        cardButtons13 = new javax.swing.JLabel();
        cardButtons14 = new javax.swing.JLabel();
        cardButtons15 = new javax.swing.JLabel();
        cardButtons16 = new javax.swing.JLabel();
        cardButtons17 = new javax.swing.JLabel();
        cardButtons18 = new javax.swing.JLabel();
        ...
        Panel.add(cardButtons1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 120, 150));
        ...
        Panel.add(cardButtons2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 120, 150));
        ...
        Panel.add(cardButtons3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 180, 120, 150));
        ...
        Panel.add(cardButtons4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 180, 120, 150));
        ...
        Panel.add(cardButtons5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 340, 120, 150));
        ...
        Panel.add(cardButtons6, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 340, 120, 150));
        ...
        Panel.add(cardButtons7, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 340, 120, 150));
        ...
        Panel.add(cardButtons8, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 340, 120, 150));
        ...
        Panel.add(cardButtons9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 500, 120, 150));
        ...
        Panel.add(cardButtons10, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 500, 120, 150));
        ...
        Panel.add(cardButtons11, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 500, 120, 150));
        ...
        Panel.add(cardButtons12, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 500, 120, 150));

        cardButtons13.setText("Deck1");
        cardButtons13.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cardButtons13.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cardButtons13MouseClicked(evt);
            }
        });
        Panel.add(cardButtons13, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 180, 120, 150));

        cardButtons14.setText("Deck1");
        cardButtons14.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cardButtons14.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cardButtons14MouseClicked(evt);
            }
        });
        Panel.add(cardButtons14, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 340, 120, 150));

        cardButtons15.setText("Deck1");
        cardButtons15.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cardButtons15.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cardButtons15MouseClicked(evt);
            }
        });
        Panel.add(cardButtons15, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 500, 120, 150));

        cardButtons16.setText("Deck1");
        cardButtons16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cardButtons16.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cardButtons16MouseClicked(evt);
            }
        });
        Panel.add(cardButtons16, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 180, 120, 150));

        cardButtons17.setText("Deck1");
        cardButtons17.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cardButtons17.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cardButtons17MouseClicked(evt);
            }
        });
        Panel.add(cardButtons17, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 340, 120, 150));

        cardButtons18.setText("Deck1");
        cardButtons18.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cardButtons18.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cardButtons18MouseClicked(evt);
            }
        });
        Panel.add(cardButtons18, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 500, 120, 150));
    ...
    private void cardButtons13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cardButtons13MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cardButtons13MouseClicked

    private void cardButtons14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cardButtons14MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cardButtons14MouseClicked

    private void cardButtons15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cardButtons15MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cardButtons15MouseClicked

    private void cardButtons16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cardButtons16MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cardButtons16MouseClicked

    private void cardButtons17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cardButtons17MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cardButtons17MouseClicked

    private void cardButtons18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cardButtons18MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cardButtons18MouseClicked
    ...
    private javax.swing.JLabel cardButtons13;
    private javax.swing.JLabel cardButtons14;
    private javax.swing.JLabel cardButtons15;
    private javax.swing.JLabel cardButtons16;
    private javax.swing.JLabel cardButtons17;
    private javax.swing.JLabel cardButtons18;
